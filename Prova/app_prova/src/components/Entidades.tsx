                ...
                <h1>Cadastradas</h1>
                    {
                        entidades.map(entidade => (
                            <div className="containerList" id={entidade.id}>
                                ...
                                <button className="buttonDeleteInput" onClick={() => {deleteEntidade(entidade.id)}}>Deletar</button>
                                { update !== entidade.id && <button className="buttonUpdateInput" onClick={() => setUpdate(entidade.id)}>Editar</button>}
                                { update === entidade.id &&
                                    <div className="container login">
