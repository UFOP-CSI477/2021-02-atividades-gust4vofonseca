            ...
            <h1>Cadastradas</h1>
                {
                    items.map(item => (
                        <div className="containerList" id={item.id}>
                            <p>{item.descricao}</p>
                            <button className="buttonDeleteInput" onClick={() => deleteItem(item.id)}>Deletar</button>
                            { update !== item.id && <button className="buttonUpdateInput" onClick={() => setUpdate(item.id)}>Editar</button>}
                            {
                                update === item.id &&
                                <div className="container login">
