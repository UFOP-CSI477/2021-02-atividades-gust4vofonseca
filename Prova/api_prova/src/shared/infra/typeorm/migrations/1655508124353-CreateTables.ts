...
export class CreateTables1655508124353 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "coletas" ("id" character varying NOT NULL, "item_id" character varying NOT NULL, "entidade_id" character varying NOT NULL, "quantidade" integer NOT NULL, "data" date NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_03c49dc94fef7c07534db841661" PRIMARY KEY ("id"))`);
